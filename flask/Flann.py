...
class Capsule():
    ...
    def query_similar_imgs(self, query_img_url):
        ...
        knn_matches = self.FLANN.knnMatch(q_des, k=5) 
...
if __name__ == "__main__":
    ...
    training_img_urls = sorted(glob('./uploads/training/*/*.jpg', recursive=True))
    ...
    query_img_urls = sorted(glob('./uploads/training/*/*test*', recursive=True))
